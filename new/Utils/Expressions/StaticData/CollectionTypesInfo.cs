...
public static class CollectionTypesInfo
{
    ...
    private static readonly Dictionary<Type, Type> _interfaceToImplementationMap = new Dictionary<Type, Type>
    {
        ...
        { typeof(IReadOnlyDictionary<,>), typeof(IvoEngine.Collections.Collections.ReadOnlyDict<,>) },
        ...
        // Other special collections
        { typeof(ILookup<,>), typeof(IvoEngine.Collections.Collections.GroupTable<,>) },    // Typically created via LINQ
